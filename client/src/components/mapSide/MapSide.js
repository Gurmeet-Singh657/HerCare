  ...
  return (
    <>
      <div className="mapside">
        ...
        <div className="incidenttitle">Have you been sexually harassed?</div>
        <div className="incidentdesc">
          ...
          patterns and create safer spaces. Information is analysed to engage
          our communities to find solutions and hold our civic and police
          officials accountable to have better policies and infrastructure. Your
          information remains anonymous.
        </div>
        <div className="incidentbtn">
          <button
            className="incidentsharebtn"
            onClick={() => navigate("/shareIncident-form")}
          >
            Share Your Incident Anonymously
          </button>
        </div>
        <div className="incidentshared">
          <div className="incidentsharedtitle">
            Incidents shared by community
          </div>
          <div className="filtersection1">
            <button
              className="filterincidents"
