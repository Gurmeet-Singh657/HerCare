export const data = [
  ...
  {
    heading: `Stalking`,
    sections: [`Section 354D of the IPC`],
    punishment: [
  ...
  {
    heading: `Ogling / Facial Expressions / Staring`,
    sections: [`Section 354A of the IPC`],
    punishment: [
      `Either simple or rigorous imprisonment for a term which may extend to 1 year, or a fine, or both.`,
    ],
  },
  {
    heading: `Taking pictures without permission`,
    sections: [`Voyeurism - Section 354C`],
    punishment: [
  ...
  {
    heading: `Indecent exposure / Masturbation in public`,
